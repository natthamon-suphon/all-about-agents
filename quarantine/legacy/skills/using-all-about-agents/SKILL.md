...
When multiple skills apply, process skills come first — they set the approach, then implementation skills (frontend-design, etc.) carry it out. Brainstorming and systematic-debugging are All About Agents' most common process skills, but the rule holds for any of them.

- "Let's build X" → all-about-agents:brainstorming first, then implementation skills.
- "Fix this bug" → all-about-agents:systematic-debugging first, then domain skills.
