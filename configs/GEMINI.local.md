...
<!--
Maintainer note (stripped before it reaches Gemini's context, costs 0 tokens):
- For TRUE global scope, this file belongs at ~/.gemini/GEMINI.md.
  GEMINI.local.md is per-project + gitignored. See https://code.claude.com/docs/en/memory
